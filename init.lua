  ...
  require('lazy').setup({
    ...
    { 'Bilal2453/luvit-meta', lazy = true },
    {
      ...
      config = function()
        ...
        --  To check the current status of installed tools and/or manually other tools, you can run
        --    :Mason
        require('mason').setup()
    ...
    { -- TODO Autoformat to adjust, maybe to remove, or use some autoformat with selection if this
    ...
    --require('custom.plugins.nvim-tree').setup(),

    -- NOTE: The import below can automatically add your own plugins, configuration, etc from `lua/custom/plugins/*.lua`
    --    This is the easiest way to modularize your config.
    --
    --  Uncomment the following lua/custom/plugins/*.lua` to get going.
